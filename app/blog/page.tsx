...
const blogPosts = [
    {
        ...
        date: '17. února 2026',
        excerpt: 'Jak efektivně renderovat tisíce řádků v Reactu pomocí virtualizace a knihovny react-window.',
    },
]
        ...
        <>
            ...
            <AnimatedSection delay={0.1}>
                <p className="text-lg my-6">
                    Sdílím poznatky z vývoje moderních webových aplikací – React, Next.js, architektura a nástroje, které dávají
                    smysl.
                </p>
            </AnimatedSection>
                ...
                <AnimatedSection key={post.slug} delay={0.15 + index * 0.08}>
                    <section className="mb-2">
                        ...
                        <InteractiveCard className="py-6 border-b border-border">
                            ...
                            <motion.div className="mt-3" whileHover={{ x: 4 }} transition={{ duration: 0.15 }}>
                                <Link href={`/blog/${post.slug}`} className="inline-block text-sm">
                                    Číst článek →
                                </Link>
                            </motion.div>
                        </InteractiveCard>
